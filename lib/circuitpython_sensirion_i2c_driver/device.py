...
class I2cDevice(object):
    ...
    :py:meth:`~circuitpython_sensirion_i2c_driver.device.I2cDevice.execute` which allows
    derived classes to easily execute an
    :py:class:`~circuitpython_sensirion_i2c_driver.command.I2cCommand` object.
    """
    ...
    def connection(self):
        ...
        :rtype: ~circuitpython_sensirion_i2c_driver.connection.I2cConnection
        """
